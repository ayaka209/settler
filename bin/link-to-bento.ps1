...
New-Item -Path ..\bento\packer_templates\ubuntu\scripts\homestead.sh -ItemType SymbolicLink -Target  ((Get-Item .).FullName +'.\scripts\provision.sh') -Force
New-Item -Path ..\bento\packer_templates\ubuntu\http\preseed.cfg -ItemType SymbolicLink -Target  ((Get-Item .).FullName + '.\http\preseed.cfg') -Force
New-Item -Path ..\bento\packer_templates\ubuntu\http\preseed-hyperv.cfg -ItemType SymbolicLink -Target  ((Get-Item .).FullName + '.\http\preseed-hyperv.cfg') -Force
